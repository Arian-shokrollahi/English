...
1. **معنی «فقط / صرفاً / تنها» (Only):**
    ...
    - _I just want a cup of water._ (من فقط یک لیوان آب میخواهم.)
    - _It’s just a game._ (این فقط یک بازیه.)
2. **معنی «همین چند لحظه پیش / یک خرده پیش» (A short time ago):**
    
    اگر **just** را در گذشته ساده (Past Simple) بین **فاعل (Subject)** و **فعل گذشته (Past Verb)** قرار دهید، معنی «همین الان / همین چند لحظه پیش / یک خرده پیش» میدهد:
